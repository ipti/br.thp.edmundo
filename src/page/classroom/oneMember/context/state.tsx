...
import { useFetchRequestFindChartUserClassroomBff, useFetchRequestFindOneUser } from "../service/query"
...
export const UpdateUserState = () => {
    ...
    }, [userRequest, classroomUserChartRequest])
    ...
    return { initialValue, UpdateUser, user, isLoading, isError, file, setFile, classroomUserChart }
}